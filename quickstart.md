...
* `src/`: Source files for the popup, [service worker script](https://developer.chrome.com/docs/extensions/mv3/service_workers/), and [content script](https://developer.chrome.com/docs/extensions/mv3/content_scripts/).
